...
[![GoDoc](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=shield)](https://pkg.go.dev/github.com/keninqiu/rosetta-sdk-go/server?tab=doc)
...
```shell
go get github.com/keninqiu/rosetta-sdk-go/server
```
